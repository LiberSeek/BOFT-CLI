...
>
> 表中的 — 表示 Host 尚未接入对应能力，不代表 CLI 本身没有。图片输入和 Teams 专用界面也未接入。版本、远程运行条件和验证范围见 [CodeBuddy 接入说明](docs/codebuddy-harness-integration.md)。
